...
async function main() {
    ...
    app.get("/video", async (req, res) => {
        ...
        if (![1, 2].includes(videoId)) {
            return res.status(400).send("Please provide id=1 or id=2");
        }

        const videoPath = videoId === 1
            ? "./videos/video-1.mp4"
            : "./videos/video-2.mp4";
        ...
        broadcastViewedMessage(messageChannel, videoId, videoPath);
    });
